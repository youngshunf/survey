...
?>	
 <img src="<?=yii::getAlias('@photo').'/roadside.png'?>" class="img-responsive" />
		
		<ul class="mui-table-view" style="margin-top:0px" >
			<li class="mui-table-view-cell">																									
				<div class="mui-pull-left">
				<p> <a id="order-status">状态:<?= CommonUtil::getDescByValue('roadside', 'status', $orderInfo->status)?></a></p>				
				</div>
				...
				<?php }elseif ($orderInfo->status==2){?>				    
					...
					<a class="mui-btn mui-btn-success"  id="roadside-again" order_guid="<?=$order['order_guid']?>">呼叫救援</a>
				<?php }else{ ?>
				<a class="mui-btn mui-btn-success" id="roadside-again" order_guid="<?=$order['order_guid']?>">呼叫救援</a>
				<?php }?>
				</div>
		...
		<!-- 	<li class="mui-table-view-cell">
		 ...
		 -->																						
			...
			<li class="mui-table-view-cell">
				<i class="icon-align-justify"></i> 订单类型:道路救援		
			</li>
			<li class="mui-table-view-cell">
			...
			<li class="mui-table-view-cell mui-media">
				<i class="icon-calendar"></i> 预计到达:<?= $orderInfo['arrive_time']?>			
			</li>		
			<?php }?>
		</ul>
			<ul class="mui-table-view">
