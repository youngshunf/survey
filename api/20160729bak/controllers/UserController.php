...
class UserController extends Controller
{
   ...
   */
   ...
   public function actionGetNotify(){
       ...
       $notify=Message::find()->andWhere(['to_user'=>$user->user_guid,'type'=>Message::SYS])->orderBy('created_at desc')->all();
        Message::updateAll(['is_read'=>1],['to_user'=>$user->user_guid,'type'=>Message::SYS]);
