        ...
        <section class="sidebar">
          ...
          <ul class="sidebar-menu">
            ...
            <?php if(yii::$app->user->identity->role_id==89){?>
             <li class="<?php if(yii::$app->controller->id=='admin-user'&&yii::$app->controller->action->id=='index') echo "active";?>" ><a href="<?= Url::to(['admin-user/index'])?>">
             <i class="fa fa-circle-o"></i> 管理员管理</a></li>
            <?php }?>
            ...
            <li class="<?php if(yii::$app->controller->id=='finance') echo "active";?> treeview">
              ...
              <ul class="treeview-menu">
                ...
                <li class="<?php if(yii::$app->controller->id=='finance'&&yii::$app->controller->action->id=='sp-finance') echo "active";?>"><a href="<?= Url::to(['finance/sp-finance'])?>"><i class="fa fa-circle-o"></i> 财务管理</a></li>
