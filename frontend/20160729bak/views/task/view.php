...
<div class="box box-success">
    ...
    <p>
        ...
        <a class="btn btn-success  option" id="option">添加问题</a>
        ...
        <?php }?>
     <a class="btn btn-success  template" id="task-template">设置为任务模板</a>
    ...
    <div class="box box-success">
      ...
      <div class="box box-success">
          ...
          <a class="btn btn-success  option" id="option">添加问题</a>
           ...
           <a class="btn btn-primary"  href="<?= Url::to(['choose-template','id'=>$model->id])?>">从模板库中选择</a>
    <?= GridView::widget([
