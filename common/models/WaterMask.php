...
*      $obj->$fontColor = array(255,23,140);          //水印文字颜色（RGB）
...
class WaterMask{
    ...
    public  $waterStr           = '随心赚';  //水印文字
    public  $fontSize           = 17;               //文字字体大小
    public  $fontColor          = array(255,0,0); //水印文字颜色（RGB）
    public  $fontFile           = 'yahei.ttf';    //字体文件
    ...
    private function waterpos() {               //水印位置算法
        switch ($this->pos) {
           ...
           case 9:     //下左
                    $this->x = 0;
                    $this->y = $this->srcImg_info[1]-$this->waterImg_info[1]-25;
                    break 1;
           case 10:    //下右
                    $this->x = $this->srcImg_info[0]-$this->waterImg_info[0];
                    $this->y = $this->srcImg_info[1]-$this->waterImg_info[1];
    ...
    private function waterstr() {
        ...
        imagettftext($this->water_im,$this->fontSize,0,0,$this->fontSize+8,$color,$this->fontFile,$this->waterStr);
